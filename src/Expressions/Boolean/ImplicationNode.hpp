#ifndef KODIAK_IMPLICATIONNODE_HPP
#define KODIAK_IMPLICATIONNODE_HPP
...
namespace kodiak {
    namespace BooleanExpressions {
        ...
        class ImplicationNode : public Node {
        public:
            ImplicationNode(const Node &lhs, const Node &rhs) : lhs(lhs.clone()), rhs(rhs.clone()) {}
